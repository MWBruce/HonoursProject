...
class FactorVAE(nn.Module):
    ...
    @staticmethod ####################################################################################################################################### What was causing the issue division by zero!!
    ...
    def forward(self, x, returns):
        ...
        # print(f"-----------------------------------------------------{np.array(x).shape}") ## (300, 20, 17)█
        ...
        # print(f"!!!!!!! {vae_loss}, {reconstruction}, {factor_mu}, {factor_sigma}, {pred_mu}, {pred_sigma}  !!!!!!!!!")
